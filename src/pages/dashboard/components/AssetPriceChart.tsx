...
export const AssetPriceChart = memo(function AssetPriceChart({
  ...
  const chartData = useMemo(() => generateChartData(baseValue, chartPeriod), [baseValue, chartPeriod]);
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary">Track price movements over time</p>
            </div>
          </div>
